  ...
  <a-card :bordered="false">
    ...
    >
      <a-form :autoFormCreate="(form)=>{this.form = form}">
        ...
        >
          <a-input placeholder="唯一识别码" :maxLength="100" v-model="mdl.id" id="no" disabled="disabled" />
        </a-form-item>
        ...
        <a-form-item
          ...
          validateStatus="success"
        >
          <a-input placeholder="起一个名字" :maxLength="100" v-model="mdl.name" id="permission_name" />
        </a-form-item>
